...
class SaveStateHandler {
  ...
  putInCookie() {
    Cookies.set('canvasAnnotatorSave', JSON.stringify(this.saveStates[this.saveIndex]), {
      expires: 99999999
    });
  }

  pullOutCookie() {
    if (Cookies.get('canvasAnnotatorSave')) {
      this.canvas.loadFromJSON(JSON.parse(Cookies.get('canvasAnnotatorSave')));
    }
  }
}
class SelfIterator {
